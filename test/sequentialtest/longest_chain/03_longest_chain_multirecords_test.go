...
func TestLongestChainAerospikeMultirecordsInvalidateWinningFork(t *testing.T) {
	...
	t.Run("invalid block with old tx", func(t *testing.T) {
		testLongestChainInvalidateWinningFork(t, utxoStore)
	})
}


func testLongestChainInvalidateWinningFork(t *testing.T, utxoStore string) {
